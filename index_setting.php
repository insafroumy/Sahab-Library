				...
				<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
					<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
						...
						<ul class="kt-menu__nav ">
							...
							<li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a href="index_setting.php"
									class="kt-menu__link "><span class="kt-menu__link-icon">
										...
										<?php if ($result->num_rows > 0) { ?>
											<?php while ($row = mysqli_fetch_array($result)) { ?>
												<tr>
													...
													<td>
													<img src="assets/bookSetting/<?php echo $row['logo'];?>" width="50" height="50">
													</td>
													<td>
														<?php echo $row['lface']; ?>
													</td>
													<td>
														<?php echo $row['ltwitter']; ?>
													</td>
													<td>
														<?php echo $row['linsta']; ?>
													</td>
													<td>
														<?php echo $row['lyoutube']; ?>
													</td>
													<td>
														<?php echo $row['lemail']; ?>
													</td>
													<td nowrap>
														<a href="edit_setting.php?id=<?php echo $row['id']; ?>"
															class="btn btn-success"><i class="la la-edit"> </i>
														</a>
													</td>
												</tr>
											<?php } ?>

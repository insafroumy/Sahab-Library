...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$input_copytext = test_input($_POST["copytext"]);
	if (empty($input_copytext)) {
		$copytext_err = "Please enter the text of copyright.";
	} else {
		$copytext = $input_copytext;
	}
	...
	if (
		...
		$stmt = $link->prepare('UPDATE copyright set copytext=?  WHERE id=?');
		...
		if ($exc) {
			...
			header("location: index_copyright.php");
			// echo "ok";
				...
				<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
					<div id="kt_aside_menu" class="kt-aside-menu" data-ktmenu-vertical="1" data-ktmenu-scroll="1"
						...
						<ul class="kt-menu__nav">
							...
							<li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a href="index_copyright.php"
									class="kt-menu__link "><span class="kt-menu__link-icon">
					...
					<div class="kt-subheader kt-grid__item" id="kt_subheader">
						<div class="kt-container kt-container--fluid">
							<div class="kt-subheader__main">
								<h3 class="kt-subheader__title">Copyright</h3>
								...
								<div class="kt-portlet__head">
									<div class="kt-portlet__head-label">
										...
										<i class="la la-pencil-square-o text-info fa-2x"></i>
											<span style="font-size : 23px">Edit Copyright</span>
										</h3>
									</div>
									...
									<div class="kt-portlet__content">
										...
										<form method="post" enctype="multipart/form-data">
											<div class="row">
												...
												$eid = $_GET['cid'];
												$ret = mysqli_query($link, "select * from copyright where id='$eid'");
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<textarea
															class="form-control "
															name="copytext" 
															placeholder="Copyright Text"><?php echo $row['copytext']; ?>
															</textarea>
														<span class="error text-danger">
															<?php echo $copytext_err ?>
														</span>
													</div>
												</div>
												<!-- end col -->

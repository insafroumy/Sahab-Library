				...
				<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
					<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
						...
						<ul class="kt-menu__nav ">
							...
							<li class="kt-menu__item " aria-haspopup="true"><a
									href="index_policy.php" class="kt-menu__link "><span class="kt-menu__link-icon">
										...
										<?php if ($result->num_rows > 0) { ?>
											<?php while ($row = mysqli_fetch_array($result)) { ?>
												<tr>
															...
															<div class="modal-dialog modal-lg modal-dialog-scrollable">
																<div class="modal-content">
																	...
																	<div class="modal-header">
																		<h1 class="modal-title">Copyright</h1>
																	...
																	<div class="modal-body">
																		<p style="font-size:18px; line-height:1.6; text-align:right;">
													...
													<td nowrap>
														<a href="edit_copyright.php?cid=<?php echo $row['id']; ?>"

...
$bname =""; $aname =""; $bdesc =""; $bdate =""; $catname =""; $bimg =""; $bpdf = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (
		...
		$sql = "INSERT INTO book (bname, aname, bdesc ,bdate , catname, bimg, bpdf) 
		VALUES (?,?,?,?,?,?,?)";
								...
								<div class="kt-portlet__head">
									<div class="kt-portlet__head-label">
										<h3 class="kt-portlet__head-title">
											<i class="la la-plus-circle text-info fa-2x"></i>
											<span style="font-size : 23px">Add Book</span>
										</h3>
									</div>
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<textarea
															class="form-control "
															name="bdesc" placeholder="Book Description">
															</textarea>
														<span class="error text-danger">
															<?php echo $bdesc_err ?>
														</span>
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="file" name="bimg"
															class="form-control "
															accept=".jpg , .png" title="Upload Image" />
														<span class="error text-danger">
															<?php echo $bimg_err ?>
														</span>
													</div>

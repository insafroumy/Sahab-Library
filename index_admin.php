					...
					<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
						...
						<ul class="kt-menu__nav ">
							...
							<li class="kt-menu__item " aria-haspopup="true"><a
									href="index_category.php" class="kt-menu__link "><span class="kt-menu__link-icon">
								...
								<div class="kt-portlet__head-toolbar">
									<div class="kt-portlet__head-wrapper">
										<div class="kt-portlet__head-actions">
											...
											<a href="add_admin.php" class="btn btn-brand btn-elevate btn-icon-sm">
										...
										<?php if ($result->num_rows > 0) { ?>
											<?php while ($row = mysqli_fetch_array($result)) { ?>
												<tr>
													...
													<td nowrap>
														<a href="edit_admin.php?cid=<?php echo $row['admin_id']; ?>"
															class="btn btn-success"><i class="la la-edit"> </i></a>
															<button class='delete btn btn-danger'
															data-id='<?php echo $row["admin_id"]; ?>'> <i class="la la-trash"> </i></button>

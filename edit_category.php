...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if ( empty($name_err) ) {
		...
		$stmt = $link->prepare('UPDATE category set cname=? WHERE cid=?');
								...
								<div class="kt-portlet__head">
									<div class="kt-portlet__head-label">
										<h2 class="kt-portlet__head-title">
											...
											<span style="font-size : 20px">Edit Category</span>
										</h2>
									</div>
									...
									<div class="kt-portlet__content">
										...
										<form method="post">
											<div class="row">
												...
												$ret = mysqli_query($link, "select * from category where cid='$eid'");

...
$lname_err = $logo_err = $lface_err = $ltwitter_err = $linsta_err = $lyoutube_err = $lemail_err = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$input_lname = test_input($_POST["lname"]);
	if (empty($input_lname)) {
		$lname_err = "Please enter the name of the library.";
	} else {
		$lname = $input_lname;
	}
	...
	if (isset($_FILES['logo']['name']) && $_FILES['logo']['name'] != "") {
		...
		$ext = explode(".", $logo);
		$image_name = "assets/bookSetting/" . $logo;
		move_uploaded_file($file_tmp, $image_name);
	} else {
		$logo_err = "Please enter an image";
	}

	$input_lface = test_input($_POST["lface"]);
	if (empty($input_lface)) {
		$lface_err = "Please enter a link of library facebook.";
	} else {
		$lface = $input_lface;
	}

	$input_ltwitter = test_input($_POST["ltwitter"]);
	if (empty($input_ltwitter)) {
		$ltwitter_err = "Please enter a link of library twitter.";
	} else {
		$ltwitter = $input_ltwitter;
	}

	$input_linsta = test_input($_POST["linsta"]);
	if (empty($input_linsta)) {
		$linsta_err = "Please enter a link of library facebook.";
	} else {
		$linsta = $input_linsta;
	}

	$input_lyoutube = test_input($_POST["lyoutube"]);
	if (empty($input_lyoutube)) {
		$lyoutube_err = "Please enter a link of library facebook.";
	} else {
		$lyoutube = $input_lyoutube;
	}

	$input_lemail = trim($_POST["lemail"]);
	if (empty($input_lemail)) {
		$lemail_err = "Please enter an email.";
	} else {
		if (!filter_var($input_lemail, FILTER_VALIDATE_EMAIL)) {
			$lemail_err = "Invalid email format";
		} else {
			$lemail = $input_lemail;
		}
	}
	...
	if (
		empty($lname_err) && empty($logo_err) && empty($lface_err) && empty($ltwitter_err) &&
		empty($lyoutube_err) && empty($linsta_err) && empty($lemail_err)
	) {

		$stmt = $link->prepare('UPDATE setting set lname=? , logo=? ,lface=? , ltwitter=? , linsta=? , lyoutube=? , lemail=?  WHERE id=?');
		...
		if ($exc) {
			...
			header("location: index_setting.php");
			// echo "ok";
				...
				<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
					<div id="kt_aside_menu" class="kt-aside-menu" data-ktmenu-vertical="1" data-ktmenu-scroll="1"
						...
						<ul class="kt-menu__nav">
							<li class="kt-menu__item  " aria-haspopup="true"><a href="index_home.php"
									class="kt-menu__link "><span class="kt-menu__link-icon">
										<i class="fa fa-home"></i>
									</span><span class="kt-menu__link-text">Dashboard</span></a></li>

							<li class="kt-menu__item " aria-haspopup="true"><a href="index_category.php"
									class="kt-menu__link "><span class="kt-menu__link-icon">
										<i class="fab fa-microsoft "></i>
									</span><span class="kt-menu__link-text ">Category</span></a>
							</li>
							<li class="kt-menu__item " aria-haspopup="true"><a href="index_admin.php"
									class="kt-menu__link "><span class="kt-menu__link-icon">

										<i class="fa fa-users "></i>
									</span><span class="kt-menu__link-text">Admins</span></a>
							</li>
							<li class="kt-menu__item " aria-haspopup="true"><a
									href="index_users.php" class="kt-menu__link "><span class="kt-menu__link-icon">
										
										<i class="la la-users "></i>
									</span><span class="kt-menu__link-text">Users</span></a>
							</li>
							<li class="kt-menu__item " aria-haspopup="true"><a href="index_book.php"
									class="kt-menu__link "><span class="kt-menu__link-icon">

										<i class="fa fa-book "></i>
									</span><span class="kt-menu__link-text">Books</span></a>
							</li>
							<li class="kt-menu__item " aria-haspopup="true"><a href="index_contact.php"
									class="kt-menu__link "><span class="kt-menu__link-icon">

										<i class="fa fa-phone-alt "></i>
									</span><span class="kt-menu__link-text">Contact</span></a>
							</li>
							<li class="kt-menu__item " aria-haspopup="true"><a href="index_policy.php"
									class="kt-menu__link "><span class="kt-menu__link-icon">

										<i class="flaticon2-sheet"></i>
									</span><span class="kt-menu__link-text">Policy</span></a>
							</li>
							<li class="kt-menu__item " aria-haspopup="true"><a href="index_copyright.php"
									class="kt-menu__link "><span class="kt-menu__link-icon">

										<i class="fas fa-copyright"></i>
									</span><span class="kt-menu__link-text">Copyright</span></a>
							</li>
							<li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a
									href="index_setting.php" class="kt-menu__link "><span class="kt-menu__link-icon">

										<i class="fa fa-cog text-info"></i>
									</span><span class="kt-menu__link-text">Setting</span></a>
							</li>
						</ul>
					</div>
				</div>
...
-->
			...
			-->
				...
				<div class="kt-content kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
					...
					<div class="kt-subheader kt-grid__item" id="kt_subheader">
						...
						<div class="kt-container  kt-container--fluid ">
							<div class="kt-subheader__main">
								<a href="logout_admin.php" class="btn btn-outline-secondary link-secondary book-btn">
									Logout
								</a>

								<a href="index.php" class="btn btn-outline-secondary link-secondary book-btn">
									Website
								</a>
					...
					<div class="kt-container kt-container--fluid kt-grid__item kt-grid__item--fluid">
						<section class="user-box">
							<!-- start my content page -->

							<!--begin::Portlet add course-->
							<div class="kt-portlet" data-ktportlet="true" id="kt_portlet_tools_1">
								<div class="kt-portlet__head">
									<div class="kt-portlet__head-label">
										<h3 class="kt-portlet__head-title">
											<i class="la la-pencil-square-o text-info fa-2x"></i>
											<span style="font-size : 23px">Edit Setting</span>
										</h3>
									</div>
									...
									<div class="kt-portlet__content">
										...
										<form method="post" enctype="multipart/form-data">
											<div class="row">
												...
												$eid = $_GET['id'];
												$ret = mysqli_query($link, "select * from setting where id='$eid'");
												while ($row = mysqli_fetch_array($ret)) {
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="file" name="logo"
																value="<?php echo $row['logo']; ?>" class="form-control "
																accept=".png , .jpg" title="Upload Image" />
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" name="lface" class="form-control  "
																value="<?php echo $row['lface']; ?>"
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" name="ltwitter" class="form-control  "
																value="<?php echo $row['ltwitter']; ?>"
																placeholder="Twitter Link" />
															<span class="error text-danger">
																<?php echo $ltwitter_err ?>
															</span>
														</div>
													</div>
													<!-- end col -->
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" name="linsta" class="form-control  "
																value="<?php echo $row['linsta']; ?>"
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" name="lyoutube" class="form-control  "
																value="<?php echo $row['lyoutube']; ?>"
																placeholder="Youtube Link" />
															<span class="error text-danger">
																<?php echo $lyoutube_err ?>
															</span>
														</div>
													</div>
													<!-- end col -->
				...
				<div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" id="kt_footer">
					<div class="kt-container kt-container--fluid">
						<div class="kt-footer__copyright">
							<?php echo date('Y'); ?>&nbsp;&copy;&nbsp;<a href="http://keenthemes.com/metronic"
	...
	<!--end::Page Scripts -->
	<!-- <script>
		var file =document.getElementById("intImg");

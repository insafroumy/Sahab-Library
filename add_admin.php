...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$input_pass = test_input($_POST["admin_password"]);
	if (empty($input_pass)) {
	...
	if (
		empty($admin_email_err) && empty($admin_password_err)
	){

		$sql = "INSERT INTO admin_login (admin_email,admin_password) 
		VALUES (?,?)";
					...
					<div id="kt_aside_menu" class="kt-aside-menu" data-ktmenu-vertical="1" data-ktmenu-scroll="1"
						...
						<ul class="kt-menu__nav">
							...
							<li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a
									href="index_admin.php" class="kt-menu__link "><span class="kt-menu__link-icon">
					...
					<div class="kt-subheader kt-grid__item" id="kt_subheader">
						<div class="kt-container kt-container--fluid">
							<div class="kt-subheader__main">
								<h3 class="kt-subheader__title">Admins</h3>
							</div>
						</div>
						<div class="kt-container  kt-container--fluid ">
							<div class="kt-subheader__main">
								...
								<div class="kt-portlet__head">
									<div class="kt-portlet__head-label">
										<h3 class="kt-portlet__head-title">
											...
											<span style="font-size : 23px">Add Admin</span>
										</h3>
									</div>
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" name="admin_email"
															class="form-control  <?php echo (!empty($admin_email)) ? 'is-invalid' : ''; ?>"
															placeholder="Admin Email" />
														<span class="error text-danger">
															<?php echo $admin_email_err ?>
														</span>
													</div>
												</div>
												<!-- end col -->
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" name="admin_password"
															class="form-control <?php echo (!empty($admin_password)) ? 'is-invalid' : ''; ?>"
															placeholder="Admin Password" />
														<span class="error text-danger">
															<?php echo $admin_password_err ?>
														</span>
													</div>
												</div>
												<!-- end col -->

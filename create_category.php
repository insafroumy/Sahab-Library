...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	// Authorization to remove unwanted spaces and characters from texts
	...
	//if for insert
	if (
		empty($name_err) && empty($email_err) && empty($phone_err) && empty($country_err) && empty($date_err)
		&& empty($specialization_err) && empty($description_err) && empty($state_err)
	) {

		$sql = "INSERT INTO category (cname) 
		VALUES (?)";
					...
					<div id="kt_aside_menu" class="kt-aside-menu" data-ktmenu-vertical="1" data-ktmenu-scroll="1"
						...
						<ul class="kt-menu__nav">
							<li class="kt-menu__item" aria-haspopup="true">
								<a href="index_home.php" class="kt-menu__link"><span class="kt-menu__link-icon">
							...
							<li class="kt-menu__item kt-menu__item--active" aria-haspopup="true">
								<a href="index_category.php" class="kt-menu__link"><span class="kt-menu__link-icon">
										<i class="fab fa-microsoft text-info"></i>
									</span><span class="kt-menu__link-text">Category</span>
								</a>
							</li>

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$input_policytext = test_input($_POST["policytext"]);
	if (empty($input_policytext)) {
		$policytext_err = "Please enter the text of policy.";
	} else {
		$policytext = $input_policytext;
	}

	$eid = $_GET['cid'];

	if (
		empty($policytext_err) 
	) {

		$stmt = $link->prepare('UPDATE policy set policytext=?  WHERE id=?');
		...
		if ($exc) {
			...
			header("location: index_policy.php");
				...
				<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
					<div id="kt_aside_menu" class="kt-aside-menu" data-ktmenu-vertical="1" data-ktmenu-scroll="1"
						...
						<ul class="kt-menu__nav">
							...
							<li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a href="index_policy.php"
									class="kt-menu__link "><span class="kt-menu__link-icon">

										<i class="flaticon2-sheet text-info"></i>
					...
					<div class="kt-subheader kt-grid__item" id="kt_subheader">
						<div class="kt-container kt-container--fluid">
							<div class="kt-subheader__main">
								<h3 class="kt-subheader__title">Policy</h3>
								...
								<div class="kt-portlet__head">
									<div class="kt-portlet__head-label">
										...
										<i class="la la-pencil-square-o text-info fa-2x"></i>
											<span style="font-size : 23px">Edit Policy</span>
										</h3>
									</div>
									...
									<div class="kt-portlet__content">
										...
										<form method="post" enctype="multipart/form-data">
											<div class="row">
												...
												$eid = $_GET['cid'];
												$ret = mysqli_query($link, "select * from policy where id='$eid'");
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<textarea
															class="form-control "
															name="policytext" 
															placeholder="Policy Text"><?php echo $row['policytext']; ?>
															</textarea>
														<span class="error text-danger">
															<?php echo $policytext_err ?>
														</span>
													</div>
												</div>
												<!-- end col -->

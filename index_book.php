								...
								<div class="kt-portlet__head-toolbar">
									<div class="kt-portlet__head-wrapper">
										<div class="kt-portlet__head-actions">
											...
											<a href="add_book.php" class="btn btn-brand btn-elevate btn-icon-sm">
										...
										<?php if ($result->num_rows > 0) { ?>
											<?php while ($row = mysqli_fetch_array($result)) { ?>
												<tr>
													...
													<td>
														<img src="/assets/bookImages/<?php echo $row['bimg']; ?>" width="50"
															height="50">
													</td>
													<td>
													...
													<td nowrap>
														<a href="edit_book.php?cid=<?php echo $row['bid']; ?>"
															class="btn btn-success"><i class="la la-edit"> </i></a>
														<button class='delete btn btn-danger'
															data-id='<?php echo $row["bid"]; ?>'> <i class="la la-trash">
															</i></button>

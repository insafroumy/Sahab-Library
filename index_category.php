								...
								<div class="kt-portlet__head-toolbar">
									<div class="kt-portlet__head-wrapper">
										<div class="kt-portlet__head-actions">
											...
											<a href="create_category.php" class="btn btn-brand btn-elevate btn-icon-sm">
										...
										<?php if ($result->num_rows > 0) { ?>
											<?php while ($row = mysqli_fetch_array($result)) { ?>
												<tr>
													...
													<td nowrap>
														<a href="edit_category.php?id=<?php echo $row['cid']; ?>"
															class="btn btn-success"><i class="la la-edit"> </i></a>
													

														<button class='delete btn btn-danger'
															data-id='<?php echo $row["cid"]; ?>'><i class="la la-trash"> </i></button>
													</td>
												</tr>
											<?php } ?>
										<?php } else

...
$sql_category = mysqli_query($link, "select cid from category order by cid");
$row1 = mysqli_num_rows($sql_category);

$sql_admin = mysqli_query($link, "select admin_id from admin_login order by admin_id");
$row2 = mysqli_num_rows($sql_admin);

$sql_book = mysqli_query($link, "select bid from book order by bid");
$row3 = mysqli_num_rows($sql_book);

$sql_users = mysqli_query($link, "select id from users order by id");
$row4 = mysqli_num_rows($sql_users);
					...
					<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
						...
						<ul class="kt-menu__nav ">
							<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a
									href="index_home.php" class="kt-menu__link "><span class="kt-menu__link-icon">
							...
							<li class="kt-menu__item " aria-haspopup="true"><a href="index_users.php"
									class="kt-menu__link "><span class="kt-menu__link-icon">
					...
					<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid ">
						...
						<div class="row  gap-3">
							<div class="col-md-4 col-lg-4 col-xl-4">
								...
								<!--begin::New Orders-->
								<div class="kt-widget24 bg-light">
									<div class="kt-widget24__details">
										<div class="kt-widget24__info">
											<h1>
												<?php echo $row1; ?>
											</h1>
											<h3 class="kt-widget24__desc text-danger">
												Categories
											</h3>
										</div>
							...
							<div class="col-md-4 col-lg-4 col-xl-4 mt-3">
								...
								<div class="kt-widget24 bg-light ">
									<div class="kt-widget24__details">
										...
										<span class="kt-widget24__stats kt-font-danger">
											<i class="la la-users fa-3x text-info"></i>
										</span>
									</div>
